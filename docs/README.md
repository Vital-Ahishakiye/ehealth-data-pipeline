...
### Pipeline Execution
![ETL Pipeline Running]([pipeline-execution.png](https://github.com/Vital-Ahishakiye/ehealth-data-pipeline/blob/main/docs/images/pipeline-execution.png))
*ETL pipeline processing 10,000 NIH records with progress logging*

### Database Schema
![Database Tables]([docs/images/database-tables.png](https://github.com/Vital-Ahishakiye/ehealth-data-pipeline/blob/main/docs/images/database-tables.png))
*Complete 14-table architecture (7 operational + 7 warehouse)*

### QA Validation
![Quality Assurance]([docs/images/qa-validation.png](https://github.com/Vital-Ahishakiye/ehealth-data-pipeline/blob/main/docs/images/qa-validation.png))
*All 9 automated validation checks passing*

### Analytics Results
![Query Results]([docs/images/docs/images/query-results(facility_distribution_by_type).png](https://github.com/Vital-Ahishakiye/ehealth-data-pipeline/blob/main/docs/images/query-results(facility_distribution_by_type).png))
